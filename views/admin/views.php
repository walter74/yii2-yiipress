...
$this->title = Yii::t('app', 'Elenco Views');
...
<div class="cms-pages-index">
    ...
    <p>
        <?= Html::a(Yii::t('app', '<i class="fa fa-plus"></i> Aggiungi View'), ['admin/views','action'=>'aggiungi'], ['class' => 'btn btn-success']) ?>
    </p>
												...
												'columns' => [
																...
																[ 
																	...
																	'urlCreator'=>function ($action, $model, $key, $index, $this) {
																							return \yii\helpers\Url::to(['admin/view','file'=>urlencode($model['file']),'action'=>$action]);
																		//return string;
																	},
																	'template'=>'{view}',
