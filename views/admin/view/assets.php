...
<div class="col-lg-12">
    ...
    <p>
        <?= Html::a(Yii::t('app', '<i class="fa fa-plus"></i> Aggiungi Asset/Sorgente'), ['admin/view','file'=>urlencode($model['file']),'action'=>'assets','subaction'=>'aggiungi'], ['class' => 'btn btn-success']) ?>
    </p> 
<section class="panel">
           <?php Pjax::begin(); ?>             
												...
												'columns' => [
																...
																[ 
																	...
																	'urlCreator'=>function ($action,$model)use($model_page){
																							         ...
																							         return \yii\helpers\Url::to(['admin/view','file'=>urlencode($model_page['file']),'action'=>'assets','asset_id'=>$model['id'],'subaction'=>$action]);
