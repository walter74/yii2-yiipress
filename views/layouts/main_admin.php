            ...
            <div class="top-nav notification-row">                
                ...
                <ul class="nav pull-right top-menu">
                     ...
                     <li>
                      ...
                      <li><a href="<?=\yii\helpers\Url::to(['site/index'])?>"><i class="fa fa-desktop"></i> Visualizza Sito</a>
                       
                    </li>
                   
                    <!-- user login dropdown start-->
                    <li>
                       <a href="<?=\yii\helpers\Url::to(['admin/logout'])?>"><i class="icon_profile"></i> LogOut</a>
                    </li>
          ...
          <div id="sidebar" class="nav-collapse " tabindex="5000" style="overflow: hidden; outline: none;">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="<?= \yii\helpers\Url::to(['admin/menu'])?>">Elenca</a></li>
                          <li><a class="" href="<?= \yii\helpers\Url::to(['admin/create','type'=>'menu'])?>">Aggiungi</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">                          
                          <li><a class="" href="<?= \yii\helpers\Url::to(['admin/pagine'])?>">Elenca</a></li>
                          <li><a class="" href="<?= \yii\helpers\Url::to(['admin/create','type'=>'page'])?>">Aggiungi</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">                          
                          <li><a class="" href="<?= \yii\helpers\Url::to(['admin/media'])?>">Elenca</a></li>
